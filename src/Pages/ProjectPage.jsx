  ...
  return (
    <div div className="homepage-bg min-h-screen select-none">
      ...
      <div>
        ...
        <div className='flex gap-3 justify-center mt-[15%] mb-[10%] md:mb-[5%] lg:mb-[5%] 2xl:mb-[5%] z-10 relative cursor-pointer custom-pointer'>
        ...
        <div className="flex flex-col items-center mb-[5%]">
          <div className="relative mx-auto w-[90%] mt-10 mb-5 2xl:mt-[8%] group">
            <img
          ...
          <div className="relative mx-auto w-[90%] mt-2 mb-5 2xl:mt-[8%] group">
            <img
