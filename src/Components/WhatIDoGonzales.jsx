    ...
    <div>
      ...
      <div>
        <div className='flex gap-1 m-1 md:flex md:justify-center lg:gap-3 2xl:lg:gap-6'>
          <div  className="h-70 w-[33%] bg-[#fff]/15 backdrop-blur-md rounded-md border-2 border-[#8F88EF]/40 shadow-xl mt-10 md:h-68 md:w-[48%] lg:h-75 lg:w-[42%] xl:h-75 xl:w-[30%] 2xl:h-140 2xl:w-[25%]">
          ...
          <div  className="h-70 w-[33%] bg-[#fff]/15 backdrop-blur-md rounded-lg border-2 border-[#8F88EF]/40 shadow-xl mt-10 pl-2 md:h-68 md:w-[48%] lg:h-75 lg:w-[42%] xl:h-75 xl:w-[30%] 2xl:h-140 2xl:w-[25%]">
        ...
        <div className='flex gap-1 mt-1 m-1 md:flex md:justify-center lg:gap-3 lg:mt-3 2xl:mt-6 2xl:gap-6'>
          <div  className=" h-75 w-[33%] bg-[#fff]/15 backdrop-blur-md rounded-lg border-2 border-[#8F88EF]/40 shadow-xl mb-30 md:h-68 md:w-[48%] lg:h-75 lg:w-[42%] xl:h-75 xl:w-[30%] 2xl:h-140 2xl:w-[25%]">
