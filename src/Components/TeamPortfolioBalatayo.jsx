  ...
  <div className="min-h-screen relative select-none">  
    <div className=" mt-[1%] md:m-2">
      ...
      <p className="max-w-[300px] mx-auto text-[1.2rem] text-[#fff] text-left ml-[4%] mt-[3%] md:text-[1.8rem] md:max-w-[600px] lg:text-[2rem] lg:max-w-[700px] xl:text-[2.2rem] xl:max-w-[750px] 2xl:text-[2.8rem] 2xl:max-w-[850px] ">  
        <Typewriter
          words={['A programmer that enjoys tinkering with databases and learning new codes and different ways to use them.']}
          loop={1}
          typeSpeed={50}
          deleteSpeed={0}
          delaySpeed={1000}
      ...
      <div className="flex flex-col items-center">
        <img src={Balatayo} alt="BalatayoImage" className="h-auto w-[80%] mt-[2%] ml-[4%] md:hidden rounded-xl"/>
      </div>
      ...
      <div className="flex mt-[10%] gap-5">
        ...
        <img src={Balatayo} alt="BalatayoImage" className="h-[300px] w-[10%] mt-[2%] ml-[1%] hidden md:flex md:h-[320px] md:w-[300px] lg:h-[420px] lg:w-[400px] lg:mt-[-5%] xl:mr-[8%] xl:h-[500px] xl:w-[470px] xl:mt-[-8%] 2xl:h-[600px] 2xl:w-[580px] 2xl:mt-[-8%] 2xl:mr-[5%] rounded-xl"/>
