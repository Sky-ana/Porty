  ...
  return (
    <div>
      ...
      <div className='gap-1 m-5 hidden md:flex md:justify-center md:gap-2 lg:gap-3 2xl:lg:gap-6'>
        <div  className="h-[490px] w-[25%] bg-[#fff]/15 backdrop-blur-md rounded-lg border-2 border-[#8F88EF]/40 shadow-xl mt-40 mb-30 xl:w-[20%] 2xl:h-[650px]">
      ...
      <div className='md:hidden'>
        ...
        <div className='flex gap-1 mt-1 m-1 md:flex md:justify-center lg:gap-3 lg:mt-3 2xl:mt-6 2xl:gap-6'>
          <div  className=" h-70 w-[50%] bg-[#fff]/15 backdrop-blur-md rounded-lg border-2 border-[#8F88EF]/40 shadow-xl mb-30 xl:w-[20%] 2xl:h-[650px] md:h-68 md:w-[46%] lg:h-75 lg:w-[42%] xl:h-75 xl:w-[30%] 2xl:h-140 2xl:w-[25%]">
            <img src={Edit} alt="Home" className="flex h-12 w-10 mt-1 md:h-15 md:w-[35%] lg:h-15 lg:w-[23%] 2xl:h-25 2xl:w-[20%]" /> 
