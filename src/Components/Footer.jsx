      ...
      <div className=''>
        ...
        <div className='text-[#726E95] text-[25px] sm:ml-[1%] md:ml-[-1%] lg:ml-[-1%] xl:ml-[-1.5%]'>
          <div className='flex flex-row'> 
            <img src={contactIcon} alt="Logo" className="h-3 w-3 ml-[4%] mt-[4%] mb-[2%] md:h-5  md:w-5  md:mt-[2.5%] 2xl:h-7 2xl:w-7" />
            <p className='text-[1.2rem] mt-[2%] mb-[2%] ml-[4%] xl:text-[1.5rem] 2xl:text-[2rem] xl:mt-[2%]'> CONTACT US </p>
          </div>

          <div className='flex flex-row'> 
            <img src={firstPersonIcon} alt="Logo" className="h-3 w-3 ml-[4%] mt-[0.8%] md:h-4 md:w-4 md:mt-[-0.6%] xl:mt-[-0.5%] 2xl:h-6 2xl:w-6 2xl:mt-[-0.8%]" />
            <p className='text-[1.2rem] mt-[-1.3%] ml-[4%] xl:text-[1.5rem] 2xl:text-[2rem]'> ic.xyrilljohn.abreu@cvsu.edu.ph </p>
          </div>

          <div className='flex flex-row'> 
            <img src={secondPersonIcon} alt="Logo" className="h-3 w-3 ml-[4%] mt-[1.8%]  md:h-4 md:w-4 md:mt-[1%] xl:mt-[1%] 2xl:h-6 2xl:w-6 2xl:mt-[0.8%]" />
            <p className='text-[1.2rem] mt-[0.3%] ml-[4%] xl:text-[1.5rem] 2xl:text-[2rem]'> ic.brielle.balatayo@cvsu.edu.ph </p>
          </div>

          <div className='flex flex-row'> 
            <img src={thirdPersonIcon} alt="Logo" className="h-3 w-3 ml-[4%] mt-[1.8%]  md:h-4 md:w-4 md:mt-[1%] xl:mt-[1%] 2xl:h-6 2xl:w-6 2xl:mt-[0.6%]" />
            <p className='text-[1.2rem] mt-[0.1%] ml-[4%] xl:text-[1.5rem] 2xl:text-[2rem]'> ic.michaelrhoi.gonzales@cvsu.edu.ph </p>
          </div>

          <div className='flex flex-row'> 
            <img src={locationIcon} alt="Logo" className="h-3 w-3 ml-[4%] mt-[2%] md:h-4 md:w-4 md:mt-[1%] xl:mt-[1%] 2xl:h-6 2xl:w-6 2xl:mt-[0.8%]" />
